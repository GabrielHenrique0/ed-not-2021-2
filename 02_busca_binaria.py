...
def busca_binaria(lista, valor_busca):
    ...
    while ini <= fim:
        ...
        # 3º caso: valor_busca é maior que lista[meio]
            ...
            comps += 2
            ini = meio + 1 # Descarta a 1ª metade a lista
...
comps = 0
hora_ini = time()
print(f"Posição de GABRIEL: {busca_binaria(nomes, 'GABRIEL')}, {comps} comparações")
hora_fim = time()
print(f"Tempo gasto procurando GABRIEL: {(hora_fim - hora_ini) * 1000}ms")
