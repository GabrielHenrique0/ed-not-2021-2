"""
    ...
    1) O ponteiro para a subárvore esquerda (left)
...
class BinarySearchTree:
    ...
    def __insert_node(self, node, root):
        ...
        if node.data < root.data:
            # Se o nodo da esquerda estiver desocupaado, faz aí a inserção
            if root.left is None: root.left = node
        # 2º caso: valor do nodo é MAIOR que o valor da raiz ~> vai para a DIREITA
        elif node.data > root.data:
            # Se o nodo da direita esstiver ddesocupado, faz aí a inserção
